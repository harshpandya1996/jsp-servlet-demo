<%-- 
    Document   : index
    Created on : May 4, 2017, 7:44:19 PM
    Author     : Harsh Pandya
--%>
    ...
    <body>
        ...
        <div class="carousel slide wet-asphalt">
            ...
            <div class="carousel-inner">
                ...
                <div class="item" style="background-image: url(images/slider/bg2-1.jpg)">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                ...
                <div class="item" style="background-image: url(images/slider/bg3-1.jpg)">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="carousel-content centered">
